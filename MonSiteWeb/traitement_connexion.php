<?php
    ...
    // Fonction qui exécute une requête SQL et retourne les résultats
    function select($req)
    {
        $cnx = connexion();
    ...
    // Fonction utile pour les requêtes SQL qui ne retournent pas de résultats, comme INSERT, UPDATE ou DELETE.

...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 14 déc. 2023 à 10:36
...
CREATE TABLE `etudiants` (
  ...
  `etude_superieur` varchar(255) DEFAULT '',
...
(5, 'Martin', 'Henry', 'MartinHenry@gmail.com', '$2y$10$KmYkYWkYS7ffMWabDHP2x.GzKH5fSamCOYziFVMVBdUsL1xQSrTIa', 'Evaluateur'),
(6, 'Martin', 'Enzo', 'MartinEnzo@gmail.com', '$2y$10$pgcb50Jn.BBYZETDI9Jt5.bcveMA2t44JLld31mFXjzj4d9NKDRka', 'Secretaire'),
(7, 'Martin', 'Maxime', 'MartinMaxime@gmail.com', '$2y$10$H0nI6NNXq4ogbISYylL/8uDdF6fOUaZNQy03QP8sdLUBfXe85TnRi', 'Administrateur');
